...
SPOTIFY_REDIRECT_URI=http://${LOCAL_IP}:5000/auth/spotify/callback
PORT=5000
ENVEOF
chown $TARGET_USER:$TARGET_USER "$PROJECT_DIR/.env"
chmod 600 "$PROJECT_DIR/.env"
echo -e "${GREEN}.env written with dynamic Redirect URI: http://${LOCAL_IP}:5000/auth/spotify/callback${NC}"
