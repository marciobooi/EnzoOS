...
const QUESTIONS = [
  {
    ...
    description: "Decide whether to use the manual parametric equalizer or let the CamillaDSP room profiler calibrate your audio output automatically.",
    options: [
      { label: "Manual Equalizer (Bypasses CamillaDSP room correction)", value: "eq" },
      { label: "CamillaDSP Room Correction (Bypasses manual equalizer)", value: "dsp" }
    ],
    action: "System Action: Selecting 'Manual Equalizer' disables CamillaDSP filters. Selecting 'CamillaDSP' activates room calibration filters."
  },
  {
    id: 1,
      ...
      <div className="flex flex-col h-full text-zinc-150 p-6 select-none font-mono">
        ...
        <div className="flex-grow flex flex-col justify-center items-center gap-3 text-center my-auto">
          ...
          <p className="text-[10px] text-zinc-400 max-w-md leading-relaxed font-sans font-medium">
            CamillaDSP room correction filters are now bypassed. Manual Parametric Equalizer mode is fully active. You can adjust presets and frequency bands by tapping the visualizer VU dial on the main display.
          </p>
        </div>
