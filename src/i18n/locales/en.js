...
export default {
  ...
  settings: {
    ...
    customFilter: 'Custom Filter (FIR)',
    customFilterNone: 'None',
    customFilterUpload: 'Upload WAV impulse response',
    customFilterUploading: 'Uploading…',
    customFilterEnable: 'Enable custom filter',
    customFilterDisable: 'Disable custom filter',
    customFilterRemove: 'Remove custom filter',
    customFilterHint: 'Replaces the 5-band equaliser with a convolution filter built from a measured impulse response (WAV). Max ~1.4s at 48kHz.',
    digitalTransport: 'Digital Transport',
    digitalTransportHint: 'Sends local/radio/Tidal/Qobuz audio straight to a chosen card, bypassing all DSP — for feeding an external DAC or processor over S/PDIF, AES/EBU or I²S. Spotify, AirPlay, UPnP and Bluetooth always stay on the normal path.',
    digitalTransportNoCards: 'No audio cards found.',
    digitalTransportCurrentDac: 'current DAC',
    digitalTransportEnable: 'Enable Digital Transport',
    digitalTransportDisable: 'Disable Digital Transport',
    display: 'Display',
