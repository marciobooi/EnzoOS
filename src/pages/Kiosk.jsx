  ...
  return (
    <div data-theme={theme} className="w-screen h-screen flex items-center justify-center relative overflow-hidden p-6 select-none font-sans">
      ...
      >
        ...
        <div 
          className={`absolute inset-0 bg-gradient-to-b from-[#e5e9f0] to-[#d8dee9] border border-zinc-300 rounded-3xl shadow-2xl z-50 transform transition-all duration-300 ease-in-out flex flex-col p-5 font-sans ${
