...
| [mpd.md](mpd.md) | Resampler (soxr), ALSA output opts, outputs (incl. Digital Transport), protocol (lsinfo/readpicture/albumart/include_optional), the `-f`/`\|` format-string gotcha | MPD 0.23.5 (corrected from a stale 0.23.14) |
